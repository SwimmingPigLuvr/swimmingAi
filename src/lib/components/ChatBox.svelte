                ...
                <div in:fade={{ duration: 5000 }} class="flex flex-col items-">
                    ...
                    >
                        {#if shouldShowUsername(index, messages)}
                            <div
                                class="text-fuchsia-400 -tracking-wide mr-1 text-left"
                            >
                                🌊🐷🩵
                            </div>
                        {/if}
                        <div
                            class="font-black text-2xl max-w-[100%] p-2 px-4 font-mono border-white border-2 text-white rounded-xl rounded-tr-none leading-tight"
                        >
                            {message.content}
                        </div>
                    </div>
        ...
        {:else}
            ...
            <div class="flex space-x-2 items-end max-w-[70%]">
                ...
                <div class="flex flex-col justify-end">
                        ...
                        <div class="text-xs ml-1">
                            <div class="flex space-x-1">
                                {#if message.passholder}
                                    ...
                                    />
                                {/if}
                                <p class="text-xl text-white font-black">
                    ...
                    {/if}
                    <div
                        class="font-black leading-snug text-xl px-4 py-1 bg-gray-200 text-black rounded-[50px] rounded-tl-none font-mono -tracking-wide"
                    >
                        {message.content}
                    </div>
                </div>
